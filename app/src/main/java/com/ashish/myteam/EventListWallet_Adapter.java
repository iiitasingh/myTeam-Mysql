...
public class EventListWallet_Adapter extends BaseAdapter {
    ...
    public EventListWallet_Adapter(Context context, int resource, ArrayList<Events_Card> eventCardDetail, String team) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.eventMemList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                memList.putExtra("members",new String[]{card.eMembers,card.eCdtMembs});
